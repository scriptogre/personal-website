...
<div style="max-width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/dQuXnEyFlMsrk0v0fG" title="Animated reaction" loading="lazy" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed rounded-lg"></iframe></div>
...
<Image src={reactZoomies} alt="React Zoomies" widths={[224, 448]} sizes="224px" quality={80} class="w-56" />
```jsx
<Calendar date="2015-06-19" {user} {events} {settings} />
```

We need to write this, just for some simple composition:
<Image src={djangonautCrying} alt="Djangonaut Crying" widths={[224, 448]} sizes="224px" quality={80} class="w-56" />
```html
...
<Image src={slippersIssue} alt="Slippers issue" widths={[480, 640]} sizes="(max-width: 672px) calc(100vw - 2rem), 672px" quality={80} />
...
<Image src={djangoTemplatePartialsPR} alt="Django Template Partials PR" widths={[480, 640]} sizes="(max-width: 672px) calc(100vw - 2rem), 672px" quality={80} />
...
If you can't beat them, join them, right? I wanted to join the zoomies. <Image src={reactZoomies} alt="React Zoomies" widths={[96, 192]} sizes="96px" quality={80} class="inline w-24" />

Still, JavaScript was insanely painful to read as a Python developer. So then it hit me:

<Image src={pythonVsJavascript} alt="Python has clean syntax, but JavaScript has clean templates" widths={[480, 640]} sizes="(max-width: 672px) calc(100vw - 2rem), 672px" quality={80} />
...
<Image src={dteVsJinjaX} alt="Django templates vs JinjaX" widths={[480, 960, 1200]} sizes="(max-width: 672px) calc(100vw - 2rem), 672px" quality={80} />
...
<div class="absolute right-5 top-4 flex items-center gap-2">
    ...
    >
      ...
      <span class="icon-[pixelarticons--debug-off] group-has-[:checked]:hidden"></span>
      <span class="icon-[pixelarticons--debug] hidden group-has-[:checked]:block"></span>
    </label>
    ...
    >
        ...
        <span class="icon-[ri--moon-clear-line] hidden group-has-[:checked]:block"></span>
    ...
    >
        ...
        <span class="icon-[majesticons--minimize] hidden group-has-[:checked]:block"></span>
    </label>
...
<Image src={functionalChatbotShowcase} alt="Functional Chatbot Showcase" widths={[480, 640]} sizes="(max-width: 672px) calc(100vw - 2rem), 672px" quality={80} />
